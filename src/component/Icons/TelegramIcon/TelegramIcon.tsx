...
export default function TelegramIcon ({width=32, height=32}) {
  return (
    <Link className="icon" href="https://t.me/" target="_blank" rel="nofollow" aria-label="Телеграм">
      <svg version="1.0" fill="#fff" xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 128.000000 128.000000">
